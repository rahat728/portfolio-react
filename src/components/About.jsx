const About = () => {
  return (
    <div
      name="about"
      className="w-full flex flex-col items-center justify-center min-h-screen bg-black text-white px-8 py-12 md:px-16 lg:px-[160px] "
    >
      <div className="max-w-[1000px] w-full flex flex-col md:flex-row gap-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-lg mb-8">
            Hi, I&apos;m Rahat. Nice to meet you! I am passionate about building
            excellent software that enhances the lives of those around me. I
            specialize in creating solutions for clients, ranging from
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4">
          <div className="w-full">
            ...
            <div className="w-full h-2 bg-gray-700 rounded">
              <div
                className="h-full bg-gradient-to-r from-green-400 to-blue-500 hover:scale-105 transition-transform duration-300 rounded"
                style={{ width: "90%" }}
              ></div>
            </div>
          </div>
